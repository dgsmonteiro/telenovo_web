...
(function () {
    ...
    angular
        .module('app.admin.userLogin')
        .controller('AppAdminUserLoginController', AppAdminUserLoginController);

    AppAdminUserLoginController.$inject = ['$state', 'userSupportService', 'cacheService', '$rootScope', 'socketService'];

    /** @ngInject */
    function AppAdminUserLoginController($state, userSupportService, cacheService, $rootScope, socketService) {
        ...
        //carga da controller
        function init() {
            vm.email = "isaias@telenovo.com.br";
