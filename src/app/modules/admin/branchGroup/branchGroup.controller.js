...
(function () {
    ...
    /** @ngInject */
    function AppAdminBranchGroupController($translate, $state, cacheService, toastr, branchNumberClientService, branchGroupClientService, lodash, $uibModal) {
        ...
        function openForm(_item) {
            $state.go('admin_branchGroup_form', {branch: _item, state_back: 'admin_branchGroup'});
        }
