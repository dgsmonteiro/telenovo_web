...
(function () {
    ...
    angular
        .module('app.admin.announcement')
        .controller('AppAdminAnnouncementController', AppAdminAnnouncementController);

    AppAdminAnnouncementController.$inject = ['$translate', '$state', 'cacheService', 'toastr', 'announcementClientService', 'lodash', '$uibModal'];


    /** @ngInject */
    function AppAdminAnnouncementController($translate, $state, cacheService, toastr, announcementClientService, lodash, $uibModal) {
        ...
        function getBranchGroup() {
            announcementClientService.getListClientBanchGroupByClientId(vm.client._id)
        ...
        function openForm(_item) {
            $state.go('admin_announcement_form', {branch: _item, state_back: 'admin_branchGroup'});
        }
