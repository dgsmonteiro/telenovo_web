...
(function () {
     ...
     .controller('AppAdminAnnouncementController', AppAdminAnnouncementFormController);

    AppAdminAnnouncementFormController.$inject = ['$translate', '$state', 'cacheService', 'announcementClientService', 'lodash', 'toastr'];
     
     
     /** @ngInject */
     function AppAdminAnnouncementFormController($translate, $state, cacheService, announcementClientService, lodash, toastr) {
