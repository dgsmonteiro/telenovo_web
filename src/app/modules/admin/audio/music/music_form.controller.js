...
(function () {
     ...
     .controller('AppAdminMusicFormController', AppAdminMusicFormController);

    AppAdminMusicFormController.$inject = ['$translate', '$state', 'cacheService', 'musicClientService', 'lodash', 'toastr'];
     
     
     /** @ngInject */
     function AppAdminMusicFormController($translate, $state, cacheService, musicClientService, lodash, toastr) {
