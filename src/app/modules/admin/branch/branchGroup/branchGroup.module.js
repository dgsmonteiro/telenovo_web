    ...
    function routeConfig($stateProvider) {
        $stateProvider
            .state('admin_branchGroup', {
                ...
                url: '/branch/branchGroup',
                parent: 'admin_desktop',
                templateUrl: 'app/modules/admin/branch/branchGroup/branchGroup.html',
            ...
            .state('admin_branchGroup_form', {
                ...
                url: '/branch/branchGroup/form',
                parent: 'admin_desktop',
                templateUrl: 'app/modules/admin/branch/branchGroup/branchGroup_form.html',
