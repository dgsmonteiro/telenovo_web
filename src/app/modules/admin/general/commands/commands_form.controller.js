...
(function () {
     ...
     .controller('AppAdminCommandsFormController', AppAdminCommandsFormController);

    AppAdminCommandsFormController.$inject = ['$translate', '$state', 'cacheService', 'generalClientService', 'lodash', 'toastr'];
     
     
     /** @ngInject */
     function AppAdminCommandsFormController($translate, $state, cacheService, generalClientService, lodash, toastr) {
