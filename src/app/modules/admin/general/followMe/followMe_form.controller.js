...
(function () {
     ...
     .controller('AppAdminFollowMeFormController', AppAdminFollowMeFormController);

    AppAdminFollowMeFormController.$inject = ['$translate', '$state', 'cacheService', 'generalClientService', 'lodash', 'toastr'];
     
     
     /** @ngInject */
     function AppAdminFollowMeFormController($translate, $state, cacheService, generalClientService, lodash, toastr) {
